...
slack_blocks_list = {
    "app_home_opened": {
        ...
        "blocks": [
                ...
                "elements": [
                    {
                        ...
                        "initial_date": (date.today() - timedelta(days=3)).strftime(
                            "%Y-%m-%d"
                        ),
                        "action_id": "startDate",
                    },
            ...
            #                 "type": "plain_text",
            #                 "emoji": True,
            #                 "text": "Unread Summarize",
            #             },
            #             "style": "danger",
            #             "value": "unread_summarize",
            #             "action_id": "unread_summarize",
            #         },
            #     ],
            # },
        ],
    ...
    "slash_loading_block": [
        {
            ...
            "elements": [
                {
                    "type": "image",
                    "image_url": "https://i.gifer.com/XVo6.gif",
                    "alt_text": "Loading...",
                },
                {
                    "type": "plain_text",
                    "text": " Please wait a minute, while we are summarizing your query...",
                },
            ],
        }
    ],
